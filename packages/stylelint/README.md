...
- Disallow default viewport-percentage units. The [`stylelint-no-default-viewport`](https://github.com/SaekiTominaga/stylelint-plugin/tree/main/packages/no-default-viewport) plugin is used.
  - 😨 `inline-size: 10vi`
  - 🙂 `inline-size: 10lvi`
- The `text-indent` property value must be 0 or greater.
  - 😨 `margin-inline-start: 1em; text-indent: -1em`
  - 🙂 `text-indent: 1em hanging`
- The `line-height` property value must be without a unit.
  - 😨 `line-height: 1.5em`
  - 🙂 `line-height: 1.5`
- The `font-weight` property value must be a number.
  - 😨 `font-weight: normal`
